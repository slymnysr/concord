...
**Faz 2 — Yüksek değer (🟡):** 4. Light tema (#44) + i18n altyapısı (#43) 5. Özel durum süre sonu (#31) + sessize-alma süreleri (#38) + otomatik rol (#27) 6. Forum etiketleri (#2) + slash argümanları (#3) 7. Sunucu-mute DB kalıcılığı (#16) + ses kalite/eşik (#13, #14) + kullanıcı taşı (#15) 8. Per-sunucu profil (#32) + aktif oturumlar (#37) + hesap sil (#36) 9. Zengin embed (#49) + arama operatörleri (#8) + bulk-delete (#7) 10. DM çağrı (#18) + thread paneli (#19)
